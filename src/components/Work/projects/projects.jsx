...
const types = [{
    id: 1, category: 'all', text: 'All'
}, {
    id: 2, category: 'first', text: 'First'
}, {
    id: 3, category: 'second', text: 'Second'
}, {
    id: 4, category: 'third', text: 'Third'
},];

const posts = [{
    id: 1, image: photo1, title: 'Video Euro 2016.', type: 'first'
}, {
    id: 2, image: photo2, title: 'Video Euro 2016.', type: 'second'
}, {
    id: 3, image: photo3, title: 'Video Euro 2016.', type: 'third'
},]
        ...
        <Container className={'-xs'}>
            <ul className='projects__types'>
                {types.map(type => {
                    ...
                    return (<motion.li variants={textAnim}
                                       custom={id}
                                       id={id}
                                       className={`projects__types-type${categoryType === category ? '--active' : ''}`}
            ...
            <motion.div
                ...
                {posts.map(project => {
                    ...
                    if (categoryType === type) {
                        return (<MCard key={id} variants={cardAnim} custom={id + 1} data={project}/>)
